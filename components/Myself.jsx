        ...
        <main id="myself" className="flex w-full px-8 text-center md:h-screen py-16 items-center md:text-left">
            <div className="max-w-[1280px] m-auto md:grid grid-cols-3 gap-8 items-center">
                <section className="col-span-2">
                    ...
                    <a href="https://www.linkedin.com/in/franco-dangelo/" target='_blank' rel="noreferrer"><span className="font-semibold text-blue-600 underline cursor-pointer">See my experience and formation in detail</span></a>
                </section>
