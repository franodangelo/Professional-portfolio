            ...
            <div className="h-full mx-auto">
                ...
                <section className="grid p-4 grid-cols-1 gap-8 md:grid-cols-3">
                    <div className="flex flex-col h-full w-full p-8 items-center justify-center shadow-md shadow-blue-200 rounded-xl relative cursor-pointer hover:shadow-lg hover:shadow-blue-300 ease-in-out duration-200">
                        ...
                        <Image className="rounded" src={propertyImg1} alt="project thumbnail" />
                        <div>
                            <div className="pb-4">
                    ...
                    <div className="flex flex-col h-auto w-full p-8 items-center justify-center shadow-md shadow-blue-200 rounded-xl relative cursor-pointer hover:shadow-lg hover:shadow-blue-300 ease-in-out duration-200">
                        ...
                        <Image className="rounded" src={propertyImg5} alt="project thumbnail" />
                        <div>
                            <div className="pb-4">
                    ...
                    <div className="flex flex-col h-auto w-full p-8 items-center justify-center shadow-md shadow-blue-200 rounded-xl relative cursor-pointer hover:shadow-lg hover:shadow-blue-300 ease-in-out duration-200">
                        ...
                        <Image className="rounded" src={propertyImg4} alt="project thumbnail" />
                        <div>
                            <div className="pb-4">
                    ...
                    <div className="flex flex-col h-auto w-full p-8 items-center justify-center shadow-md shadow-blue-200 rounded-xl relative cursor-pointer hover:shadow-lg hover:shadow-blue-300 ease-in-out duration-200">
                        <span className="flex mb-4 py-1 px-2 self-end text-xs text-white bg-blue-600/50 rounded-md uppercase">{texts.projectsAug} 22</span>
                        <Image className="rounded" src={propertyImg3} alt="project thumbnail" />
                        <div>
                            <div className="pb-4">
                    ...
                    <div className="flex flex-col h-auto w-full p-8 items-center justify-center shadow-md shadow-blue-200 rounded-xl relative cursor-pointer hover:shadow-lg hover:shadow-blue-300 ease-in-out duration-200">
                        ...
                        <Image className="rounded" src={propertyImg2} alt="project thumbnail" />
                        <div>
                            <div className="pb-4">
